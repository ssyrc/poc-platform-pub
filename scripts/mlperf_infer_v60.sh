...
MLPERF_ROOT="${MLPERF_ROOT:-${POC_PLATFORM_ROOT:-$(cd "${SCRIPT_DIR}/.." && pwd)}}"; DATA_ROOT="${MLPERF_DATA_ROOT:-${DATA_ROOT:-${MLPERF_ROOT}/data}}"; LOG_ROOT="/opt/poc-platform/mlperf_logs_infer_v60"; CONFIG_PATH=""; DRY_RUN="false"
while [[ $# -gt 0 ]]; do
  case "$1" in
